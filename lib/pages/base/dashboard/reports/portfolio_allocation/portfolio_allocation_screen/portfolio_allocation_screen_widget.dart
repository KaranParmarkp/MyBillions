    ...
    return Padding(
      ...
      child: FutureBuilder<ApiCallResponse>(
        ...
        builder: (context, snapshot) {
          ...
          final columnPortfolioAllocationResponse = snapshot.data!;
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future:
                            MyBillionsApiGroupGroup.reportsPfDropdownCall.call(
                          customerID: currentUserData?.customerId,
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          ...
                          final applicantDropdownReportsPfDropdownResponse =
                              snapshot.data!;
                          ...
                          FlutterFlowPieChart(
                            data: FFPieChartData(
                              values: MyBillionsApiGroupGroup
                                  ...
                                  .categoryPercent(
                                columnPortfolioAllocationResponse.jsonBody,
                              )!,
                ...
                wrapWithModel(
                  ...
                  child: ThreeHeaderTableWidget(
                    ...
                    header2: 'Amount (INR)',
                    header3: '% Share',
                    header1List: MyBillionsApiGroupGroup.portfolioAllocationCall
                        .schemeType(
                      columnPortfolioAllocationResponse.jsonBody,
                    )!,
                    header2List: MyBillionsApiGroupGroup.portfolioAllocationCall
                        .schemeTypeTotal(
                      columnPortfolioAllocationResponse.jsonBody,
                    )!,
                    header3List: MyBillionsApiGroupGroup.portfolioAllocationCall
                        .schemeTypePercent(
                      columnPortfolioAllocationResponse.jsonBody,
                    )!,
                ...
                wrapWithModel(
                  ...
                  child: DebtWiseWidget(
                    debtJson: MyBillionsApiGroupGroup.portfolioAllocationCall
                        .debtList(
                      columnPortfolioAllocationResponse.jsonBody,
                    )!,
                  ),
                ...
                wrapWithModel(
                  ...
                  child: EquityWiseWidget(
                    equityJson: MyBillionsApiGroupGroup.portfolioAllocationCall
                        .equityList(
                      columnPortfolioAllocationResponse.jsonBody,
                    )!,
                  ),
