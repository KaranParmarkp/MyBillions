...
class PfFiltersWidget extends StatefulWidget {
  const PfFiltersWidget({super.key});
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      controller: _model.applicantDropdownValueController ??=
                          FormFieldController<String>(null),
                      options: MyBillionsApiGroupGroup.reportsPfDropdownCall
                          .investorNames(
                        columnReportsPfDropdownResponse.jsonBody,
                      )!,
                      onChanged: (val) =>
                          setState(() => _model.applicantDropdownValue = val),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      onChanged: (val) =>
                          setState(() => _model.goalsDropdownValue = val),
                      width: double.infinity,
                      height: 40.0,
                      textStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      onChanged: (val) =>
                          setState(() => _model.categoryDropdownValue = val),
                      width: double.infinity,
                      height: 40.0,
                      textStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
