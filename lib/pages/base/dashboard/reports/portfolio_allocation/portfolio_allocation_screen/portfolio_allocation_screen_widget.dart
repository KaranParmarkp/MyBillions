        ...
        return Container(
          ...
          child: FutureBuilder<ApiCallResponse>(
            ...
            builder: (context, snapshot) {
              ...
              print((containerPortfolioAllocationResponse.jsonBody["portBy_Equity"] as List).isEmpty);
              return Container(
                decoration: const BoxDecoration(),
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        if((containerPortfolioAllocationResponse.jsonBody["portBy_Equity"] as List).isNotEmpty)Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
