...
class ReportsModel extends FlutterFlowModel<ReportsWidget> {
  ...
  // Model for capital_gain_list component.
  late CapitalGainListModel capitalGainListModel;
  ...
  void initState(BuildContext context) {
    ...
    capitalGainListModel = createModel(context, () => CapitalGainListModel());
  }
