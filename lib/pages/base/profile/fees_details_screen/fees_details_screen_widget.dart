...
import 'fees_details_screen_model.dart';
export 'fees_details_screen_model.dart';
...
class _FeesDetailsScreenWidgetState extends State<FeesDetailsScreenWidget> {
  late FeesDetailsScreenModel _model;
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: FutureBuilder<ApiCallResponse>(
                future: MyBillionsApiGroupGroup.feesDetailsCall.call(
                  ...
                  return Builder(
                    builder: (context) {
                      final feeList = MyBillionsApiGroupGroup.feesDetailsCall
                              .invoicerept(
                                listViewFeesDetailsResponse.jsonBody,
                              )
                              ?.toList() ??
                          [];
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, feeListIndex) {
                          final feeListItem = feeList[feeListIndex];
                          return Padding(
