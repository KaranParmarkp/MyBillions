...
import 'client_screen_model.dart';
export 'client_screen_model.dart';
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: FutureBuilder<ApiCallResponse>(
                future: MyBillionsApiGroupGroup.clientManagementCall.call(
                ...
                builder: (context, snapshot) {
                  ...
                  return Builder(
                    builder: (context) {
                      final invList =
                          MyBillionsApiGroupGroup.clientManagementCall
                                  .investors(
                                    listViewClientManagementResponse.jsonBody,
                                  )
                                  ?.toList() ??
                              [];
