...
import 'financial_question_screen_model.dart';
export 'financial_question_screen_model.dart';

class FinancialQuestionScreenWidget extends StatefulWidget {
  const FinancialQuestionScreenWidget({
    super.key,
  ...
  State<FinancialQuestionScreenWidget> createState() =>
      _FinancialQuestionScreenWidgetState();
}

class _FinancialQuestionScreenWidgetState
    extends State<FinancialQuestionScreenWidget> {
  late FinancialQuestionScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FinancialQuestionScreenModel());
