...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFCC00);
  late Color secondary = const Color(0xFFFFCC00);
  ...
  late Color secondaryLight = Color(0x79FDBD00);
  late Color containerBG = Color(0xFF1A1B1E);
  late Color containerBorder = Color(0xFF363739);
}
