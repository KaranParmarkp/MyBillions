...
import 'transaction_report_filters_model.dart';
export 'transaction_report_filters_model.dart';

class TransactionReportFiltersWidget extends StatefulWidget {
  const TransactionReportFiltersWidget({
    super.key,
  ...
  @override
  State<TransactionReportFiltersWidget> createState() => _TransactionReportFiltersWidgetState();
}

class _TransactionReportFiltersWidgetState extends State<TransactionReportFiltersWidget> {
  late TransactionReportFiltersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionReportFiltersModel());
